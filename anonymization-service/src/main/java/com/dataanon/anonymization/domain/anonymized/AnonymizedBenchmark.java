package com.dataanon.anonymization.domain.anonymized;
...
@Entity
@Table(
    name = "anonymized_benchmarks",
    schema = "anonymized",
    uniqueConstraints = @UniqueConstraint(columnNames = {"sector_id", "metric_id", "year", "month"})
)
@Getter
@Setter
@NoArgsConstructor
